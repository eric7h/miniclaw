...
<p align="center">
  <a href="https://github.com/eric7h/miniclaw"><img src="https://img.shields.io/badge/GitHub-eric7h%2Fminiclaw-181717?logo=github" alt="GitHub" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-0B7285" alt="MIT License" /></a>
  <img src="https://img.shields.io/badge/Runtime-Pi%20Agent-6D28D9" alt="Pi Agent Runtime" />
  <img src="https://img.shields.io/badge/Channels-7-C2410C" alt="7 IM channels" />
</p>

<p align="center">
  <a href="https://github.com/eric7h/miniclaw">GitHub</a> ·
...
它采用智能体优先工作模型：用户先配置可长期存在的 Agent 身份与能力，再让 Session 承载一次次具体执行，而不是把所有配置都塞进临时聊天。
...
flowchart TB
  ...
  subgraph Backend[Miniclaw Backend]
    Auth[Auth & ACL]
    Queue[Queue & Scheduler]
    Profile[Agent Profile]
    Workspace[Workspace & Session]
    Capability[Skills / MCP / Plugins]
    Memory[Memory & FTS5]
    Delivery[StreamEvent & Delivery]
  end
  subgraph Runner[执行层]
    Host[Host Runner]
...
```bash
git clone https://github.com/eric7h/miniclaw.git
cd miniclaw
